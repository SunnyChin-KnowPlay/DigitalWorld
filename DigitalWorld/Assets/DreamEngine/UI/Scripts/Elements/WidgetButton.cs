...
namespace DreamEngine.UI
{
    ...
    public class WidgetButton : Widget, IPointerEnterHandler, IPointerExitHandler, IPointerDownHandler
    {
        ...
        protected override void Awake()
        {
            ...
            if (useCustomContent == false) { UpdateUI(); }
            if (targetButton != null) { StartCoroutine(nameof(FixLayout)); }
        }
        ...
        IEnumerator FadeIn()
        {
            ...
            while (currenthighlightedValue <= 1)
            {
                ...
                if (normalCG.alpha >= 1) { StopCoroutine(nameof(FadeIn)); }
                yield return null;
            }
        }
        ...
        IEnumerator FadeOut()
        {
            ...
            while (currentNormalValue >= 0)
            {
                ...
                if (highlightedCG.alpha <= 0) { StopCoroutine(nameof(FadeOut)); }
                yield return null;
            }
        }
